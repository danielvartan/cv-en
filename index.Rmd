...
<!-- <p style="font-size: 0.7rem;">Computational social scientist specialized in agent-based modeling, data science, and open-source scientific software. Significant expertise in R, Python, and NetLogo, with demonstrable skills in building interactive models, dashboards, and research tools for exploring social, environmental, and health-related phenomena. Experienced collaborating in and leading interdisciplinary research teams, publishing in peer-reviewed journals, securing research funding, and presenting results internationally. Committed to open science, stakeholder engagement, and clear communication. Fluent in English and Portuguese.<p> -->
...
<i class="fa-solid fa-crow"></i> [danielvartan](https://www.duolingo.com/profile/danielvartan)
...
<!-- <p style="margin-block-start: 0em;">• Programming: R, NetLogo, Python, SQL, JavaScript (D3.js, Plotly, Flask/Django – more to learn), Bash, HTML/CSS, Git

<p style="margin-block-start: 0em;">• Visualization: R Shiny, custom dashboards, NetLogo visual outputs, spatial and network data visualization</p>

<p style="margin-block-start: 0em;">• Modeling & Analysis: Agent-based modeling, complex networks, machine learning, temporal and spatial analytics, survey and quantitative research methods</p>

<p style="margin-block-start: 0em;">• Project Management & Grants: Successful Brazilian and multi-team projects, proposal development, budgeting and team coordination</p>

<p style="margin-block-start: 0em;">• Stakeholder Collaboration: Workshops/training for practitioners, public health engagement, interdisciplinary and international teamwork</p>

<h2>International and Relocation Readiness</h2>

<p style="margin-block-start: 0em;">• Collaborated on projects with teams in Brazil, the US, UK, and across Latin America; experienced in remote, multicultural scientific environments.</p>

<p style="margin-block-start: 0em;">• Fully prepared to relocate to Norway and learn Norwegian.</p> -->
...
<p style="margin-block-start: 0em;">Grant proposal writing</p>
...
## Grants, Awards & Fellowships {#funding data-icon=award}
...
## Extension Projects {#extension data-icon=users}

```{r}
cv <- cv |> print_section("extension_projects")
```

## Talks {#talks data-icon=comments}
